...
const Education = () => {
  const educationData = [
    {
      school: 'College of Information Systems',
      location: 'Bacnotan, La Union, Philippines',
      duration: 'August 2021 - May 2025',
      degree: 'Bachelor of Science in Information Systems(Specialized in Business Analytics)',
      grade: 'CGPA: 1.75 (88.8%)',
      image: collegeImg,
      resultUrl: bTechPdf,
      coursework: ["Software Development", 'PHP', 'Data Analytics', 'Data Structures and Algorithms', 'OOP', 'System Analysis and Design', 'Analytics Application'],
      description:
        'During my time at CIS, I have built a strong foundation in computer computer, focusing on software development, problem-solving, business and data analytics, and real-world applications. Engaging in hands-on projects, internships, and coding challenges has helped me enhance my technical and analytical skills.',
    },
    {
      ...
      description:
        'During my college years, I built a strong foundation in technology and software development, enhancing my analytical thinking and problem-solving skills. The combination of academic learning and hands-on projects played a significant role in developing my passion for creating innovative software solutions.',
    },
  ]
