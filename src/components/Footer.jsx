      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-12">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">Jane Winslet L. Pacpaco</span>
            </Link>
            <p className="text-sm text-gray-400">
              Software Developer based in San Fernando City, La Union, Philippines.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="mailto:lopezjanewinslet@gmail.com"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Email Jane Winslet L. Pacpaco"
                >
                  <Mail className="w-4 h-4" aria-hidden="true" />
                  lopezjanewinslet@gmail.com
                </a>
              </li>
              <li>
                <a
                  href="tel:+639514422731"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Call Jane Winslet Pacpaco"
                >
        ...
        <div className="border-t border-white/10 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Jane Winslet L. Pacpaco. All rights reserved.
            </p>
